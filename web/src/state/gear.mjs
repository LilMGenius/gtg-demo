...
// 장갑과 같은 값 기준을 쓴다. 첫 칸은 이적시장 380 골드보다 싸고 마지막 칸은 그보다 비싸다.
//
export const BOOTS = [
...
// 값 기준은 앞의 둘과 같다. 첫 칸은 이적시장 380 골드보다 싸고 마지막 칸은 그보다 비싸다.
//
export const KITS = [
...
// 값 기준은 앞의 셋과 같다. 첫 칸은 이적시장 380 골드보다 싸고 마지막 칸은 그보다 비싸다.
//
export const SOCKS = [
...
// 값 기준은 앞의 넷과 같다. 첫 칸은 이적시장 380 골드보다 싸고 마지막 칸은 그보다 비싸다.
//
export const GOALS = [
...
// 값 기준은 앞의 다섯과 같다. 첫 칸은 이적시장 380 골드보다 싸고 마지막 칸은 그보다 비싸다.
...
export const CITIES = [
  ...
  { city: 2, name: '잔디 축구장', cost: 385, note: '유동인구가 많다. 막으면 소문이 빨리 난다',
    ground: 0x658562, fence: 0x8a9099, rise: 1.1 },
  { city: 3, name: '프로 경기장', cost: 860, note: '사방이 사람이다. 팔로워도 실점도 같이 는다',
    ground: 0x547757, fence: 0xb0b6bd, rise: 1.55 }
];
...
// 값 기준은 앞의 여섯과 같다. 첫 칸은 이적시장 380 골드보다 싸고 마지막 칸은 그보다 비싸다.
export const HAIRS = [
...
// 값 기준은 앞의 일곱과 같다. 첫 칸은 이적시장 380 골드보다 싸고 마지막 칸은 그보다 비싸다.
