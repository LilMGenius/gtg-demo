    ...
    if (tail) {
      ...
      switch (tail.kind) {
        ...
        case 'charge':
          ...
          // 얼마나 멀리 나가 서는지는 매번 다르다. 폭 0.8은 CHARGE_Z 4.2에서 beat가 가는 9.4까지의
          // 거리에 비해 작아, 돌진이 다른 사건으로 읽히기 시작하는 선을 안 건드린다.
          keeper.position.z = lerp(KEEPER_Z, CHARGE_Z + (tail.vary.a - 0.5) * 0.8, e);
