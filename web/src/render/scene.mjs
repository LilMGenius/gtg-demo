...
export function createScene(canvas) {
  ...
  const CAM_EV = {
    save: { pos: [0, -0.3, 0.55], look: [0, -0.08, 0], fov: -2, dur: 0.8 },
    ...
    carriedIn: { pos: [0, -1.15, 0.45], look: [0, -0.42, 0.5], fov: -3, dur: 1.1 },
    ...
    downed: { pos: [0, -0.9, 0.6], look: [0, -0.52, 0.25], fov: -2, dur: 1.05 },
