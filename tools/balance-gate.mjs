...
// 의도한 이동: 자리와 읽기 분리, 봇의 접촉 전 선점 제거, 위치 전용 비행 기울기와 몸 블록을 수락했다.
// 이 게이트의 실측값이며 keeperAtLevel 기준 모집단(N칸 중 셋 제시, 레벨당 3포인트)은 제품의 열다섯 스탯 화면과 세트당 2포인트와 다르고, 제품 모집단은 tools/product-pop-gate.mjs가 잰다.
// P15-U3d의 수락 구조를 같은 이천 시드로 재측정했다. 신인 보호, 단조 성장, 성장 폭 가드는 그대로다.
const BASE = { new: 16.75, 1: 16.45, 3: 18.79, 5: 21.07, 7: 22.89, 10: 26.06, 15: 31.27, 20: 36.30, 30: 46.14 };
