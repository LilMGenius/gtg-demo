...
// 게임 용어로 비틀 수 있으면 그쪽을 쓴다. 매쉬, 픽셀로, 셰이더첸코, 렌더슨, 캐시카.
...
export const KICKERS = [
  ...
  { name: '음바뽕',      role: '공격수',   finishing: 9,  power: 8,  composure: 7, curve: 5,  flair: 8,  fame: 10, height: 178, weight: 73 },
  ...
  { name: '수아래스',    role: '공격수',   finishing: 9,  power: 7,  composure: 6, curve: 6,  flair: 7,  fame: 8,  height: 182, weight: 85 },
  { name: '아구해요',    role: '공격수',   finishing: 9,  power: 8,  composure: 7, curve: 5,  flair: 7,  fame: 8,  height: 173, weight: 74 },
  { name: '케잌',        role: '공격수',   finishing: 9,  power: 8,  composure: 8, curve: 6,  flair: 6,  fame: 8,  height: 188, weight: 86 },
  { name: '호나웃도',    role: '공격수',   finishing: 10, power: 9,  composure: 8, curve: 6,  flair: 9,  fame: 10, height: 183, weight: 82 },
  ...
  { name: '이불하나받쳐', role: '공격수',  finishing: 9,  power: 10, composure: 6, curve: 6,  flair: 10, fame: 9,  height: 195, weight: 95 },
  ...
  { name: '아디다요',    role: '공격수',   finishing: 7,  power: 7,  composure: 4, curve: 4,  flair: 6,  fame: 6,  height: 191, weight: 80 },
  { name: '발로찼니',    role: '공격수',   finishing: 8,  power: 10, composure: 2, curve: 5,  flair: 8,  fame: 8,  height: 189, weight: 88 },
  { name: '데베짱',      role: '공격수',   finishing: 8,  power: 7,  composure: 5, curve: 4,  flair: 6,  fame: 7,  height: 173, weight: 71 },
  ...
  { name: '아냐르카',    role: '공격수',   finishing: 7,  power: 7,  composure: 5, curve: 5,  flair: 7,  fame: 6,  height: 177, weight: 75 },
  ...
  { name: '차밤근',      role: '공격수',   finishing: 8,  power: 10, composure: 7, curve: 4,  flair: 5,  fame: 8,  height: 180, weight: 78 },
  { name: '안정된환',    role: '공격수',   finishing: 8,  power: 6,  composure: 7, curve: 5,  flair: 6,  fame: 7,  height: 186, weight: 80 },
  { name: '이동극',      role: '공격수',   finishing: 8,  power: 8,  composure: 6, curve: 5,  flair: 5,  fame: 7,  height: 185, weight: 80 },
  ...
  { name: '제라드늄',      role: '미드필더', finishing: 8,  power: 9,  composure: 6, curve: 7,  flair: 7,  fame: 8,  height: 185, weight: 83 },
  { name: '램프',        role: '미드필더', finishing: 8,  power: 8,  composure: 7, curve: 6,  flair: 6,  fame: 7,  height: 183, weight: 88 },
  { name: '스콜스콜',      role: '미드필더', finishing: 7,  power: 7,  composure: 7, curve: 6,  flair: 6,  fame: 6,  height: 170, weight: 70 },
  { name: '긱스나',        role: '미드필더', finishing: 6,  power: 5,  composure: 6, curve: 7,  flair: 8,  fame: 8,  height: 180, weight: 67 },
  { name: '캐시카',        role: '미드필더', finishing: 8,  power: 7,  composure: 8, curve: 5,  flair: 8,  fame: 9,  height: 186, weight: 82 },
  { name: '박지승',      role: '미드필더', finishing: 6,  power: 6,  composure: 7, curve: 4,  flair: 5,  fame: 8,  height: 178, weight: 70 },
  { name: '간지리',      role: '미드필더', finishing: 7,  power: 7,  composure: 8, curve: 10, flair: 9,  fame: 8,  height: 173, weight: 68 },
  ...
  { name: '네스타나',      role: '수비수',   finishing: 2,  power: 7,  composure: 4, curve: 2,  flair: 3,  fame: 6,  height: 188, weight: 85 },
  ...
  { name: '음뻐뻬',      role: '공격수',   finishing: 9,  power: 8,  composure: 7, curve: 5,  flair: 8,  fame: 10, height: 178, weight: 75 },
  { name: '살라흙',      role: '공격수',   finishing: 9,  power: 7,  composure: 8, curve: 8,  flair: 7,  fame: 10, height: 175, weight: 71 },
  ...
  { name: '더브라위나',  role: '미드필더', finishing: 8,  power: 10, composure: 9, curve: 10, flair: 8,  fame: 10, height: 181, weight: 76 },
  { name: '로드리고쓰',  role: '미드필더', finishing: 6,  power: 8,  composure: 9, curve: 5,  flair: 6,  fame: 9,  height: 191, weight: 82 },
  { name: '주드안주드',  role: '미드필더', finishing: 7,  power: 7,  composure: 7, curve: 6,  flair: 7,  fame: 8,  height: 184, weight: 78 },
  ...
  { name: '이강임',      role: '미드필더', finishing: 7,  power: 7,  composure: 8, curve: 9,  flair: 9,  fame: 8,  height: 173, weight: 68 },
  { name: '황희잔',      role: '공격수',   finishing: 7,  power: 8,  composure: 6, curve: 5,  flair: 6,  fame: 7,  height: 177, weight: 77 },
  { name: '김밍재',      role: '수비수',   finishing: 4,  power: 9,  composure: 6, curve: 3,  flair: 4,  fame: 8,  height: 190, weight: 88 },
  { name: '오현겨',      role: '공격수',   finishing: 7,  power: 7,  composure: 6, curve: 6,  flair: 6,  fame: 7,  height: 177, weight: 74 },
  { name: '이재썽',      role: '미드필더', finishing: 6,  power: 8,  composure: 7, curve: 6,  flair: 6,  fame: 7,  height: 187, weight: 82 },
...
export const KEEPERS = [
  ...
  { name: '김병자',     diving: 7,  handling: 7,  reflex: 8,  offball: 7, judgement: 6, agility: 8, balance: 7, strength: 7, mischief: 10, height: 182, weight: 78, fame: 9, traits: ['스위퍼키퍼', '발빠른재간'] },
  ...
  { name: '알리아손',   diving: 9,  handling: 9,  reflex: 9,  offball: 8, judgement: 8, agility: 8, balance: 8, strength: 8, mischief: 3, height: 193, weight: 91, fame: 9,  traits: ['크로스인터셉터'] },
  ...
  { name: '슈마이컬터', diving: 8,  handling: 8,  reflex: 9,  offball: 8, judgement: 8, agility: 7, balance: 8, strength: 9, mischief: 8, height: 191, weight: 95, fame: 9,  traits: ['갓핸드'] },
  ...
  { name: '판더머여',     diving: 7,  handling: 7,  reflex: 7,  offball: 7, judgement: 7, agility: 6, balance: 7, strength: 8, mischief: 4, height: 194, weight: 92, fame: 6,  traits: [] },
  ...
  { name: '프레임드',   diving: 7,  handling: 7,  reflex: 8,  offball: 7, judgement: 7, agility: 7, balance: 7, strength: 7, mischief: 3, height: 188, weight: 86, fame: 6,  traits: [] },
  { name: '프레이저',       diving: 7,  handling: 8,  reflex: 8,  offball: 8, judgement: 8, agility: 7, balance: 8, strength: 7, mischief: 3, height: 190, weight: 86, fame: 7,  traits: [] },
  { name: '툴돌람',     diving: 8,  handling: 6,  reflex: 8,  offball: 6, judgement: 6, agility: 8, balance: 7, strength: 6, mischief: 6, height: 182, weight: 79, fame: 6,  traits: [] },
  ...
  { name: '핏포드',     diving: 7,  handling: 6,  reflex: 8,  offball: 6, judgement: 6, agility: 8, balance: 7, strength: 6, mischief: 6, height: 185, weight: 77, fame: 7,  traits: [] },
  { name: '슈마이켈딸',   diving: 8,  handling: 7,  reflex: 9,  offball: 7, judgement: 7, agility: 8, balance: 7, strength: 7, mischief: 4, height: 189, weight: 89, fame: 7,  traits: [] },
  ...
  { name: '밸리',   diving: 7,  handling: 7,  reflex: 7,  offball: 7, judgement: 7, agility: 7, balance: 7, strength: 7, mischief: 5, height: 186, weight: 83, fame: 5,  traits: [] },
  ...
  { name: '김성근한',   diving: 7,  handling: 7,  reflex: 7,  offball: 7, judgement: 7, agility: 6, balance: 7, strength: 8, mischief: 3, height: 192, weight: 87, fame: 6,  traits: [] },
  ...
  { name: '알리썰',   diving: 6,  handling: 6,  reflex: 6,  offball: 6, judgement: 6, agility: 6, balance: 6, strength: 6, mischief: 5, height: 184, weight: 80, fame: 4,  traits: [] },
  ...
  { name: '트루블린',     diving: 7,  handling: 7,  reflex: 8,  offball: 7, judgement: 7, agility: 7, balance: 7, strength: 7, mischief: 4, height: 190, weight: 85, fame: 6,  traits: [] },
  ...
  { name: '누벨',         diving: 8,  handling: 7,  reflex: 8,  offball: 7, judgement: 7, agility: 8, balance: 7, strength: 7, mischief: 5, height: 194, weight: 87, fame: 6,  traits: [] },
  { name: '조현웅',       diving: 8,  handling: 7,  reflex: 8,  offball: 7, judgement: 7, agility: 7, balance: 7, strength: 8, mischief: 4, height: 189, weight: 86, fame: 7,  traits: [] },
  { name: '김준홍아',     diving: 7,  handling: 7,  reflex: 7,  offball: 7, judgement: 6, agility: 7, balance: 7, strength: 7, mischief: 5, height: 190, weight: 84, fame: 5,  traits: [] },
  { name: '송범군',       diving: 7,  handling: 6,  reflex: 7,  offball: 6, judgement: 6, agility: 7, balance: 6, strength: 7, mischief: 6, height: 194, weight: 88, fame: 5,  traits: [] },
  { name: '치과세크',     diving: 8,  handling: 7,  reflex: 8,  offball: 7, judgement: 7, agility: 7, balance: 7, strength: 8, mischief: 4, height: 196, weight: 90, fame: 6,  traits: [] },
  { name: '깁스',         diving: 6,  handling: 5,  reflex: 6,  offball: 5, judgement: 4, agility: 6, balance: 5, strength: 6, mischief: 8, height: 188, weight: 84, fame: 5,  traits: [] },
  { name: '옥사끼',       diving: 6,  handling: 4,  reflex: 6,  offball: 5, judgement: 4, agility: 6, balance: 5, strength: 5, mischief: 9, height: 183, weight: 79, fame: 4,  traits: [] },
